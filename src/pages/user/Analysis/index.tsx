...
const Analysis = () => {
    ...
    useEffect(() => {
        ...
        const fetchInitialData = async () => {
            ...
            try {
                ...
                if (studentId) {
                    data = await studentStatisticsService.getStudentStatistics(parseInt(studentId));
                } else {
    ...
    const handleFilterChange = (field: keyof typeof filters, value: string | Dayjs | null) => {
        setFilters(prev => ({
            ...prev,
            [field]: value
        }));
    ...
    const applyFilters = async () => {
        ...
        try {
            ...
            if ((filterData.startDate || filterData.endDate) && !filterData.timePeriod) {
                data = await studentStatisticsService.getDateRangeStatistics(
                    parseInt(studentId!),
                ...
                data = await studentStatisticsService.getFilteredStudentStatistics(parseInt(studentId!), filterData);
                setStats(data as unknown as StudentStats);
            }
